...
Mango::EditorViewport::EditorViewport(EditorViewportCreateInfo createInfo)
...
Mango::EditorViewport::~EditorViewport()
{
...
void Mango::EditorViewport::InitializeViewportImage()
{
    const auto& vkLogicalDevice = _logicalDevice->GetDevice();
    ...
    vkCreateImage(vkLogicalDevice, &info, nullptr, &_viewportImage);
    ...
    vkAllocateMemory(vkLogicalDevice, &memoryAllocateInfo, nullptr, &_viewportImageMemory);
    vkBindImageMemory(vkLogicalDevice, _viewportImage, _viewportImageMemory, 0);
}

void Mango::EditorViewport::InitializeViewportImageView()
{
    ...
    vkCreateImageView(_logicalDevice->GetDevice(), &imageViewCreateInfo, nullptr, &_viewportImageView);
}

void Mango::EditorViewport::InitializeImageSampler()
{
    ...
    vkCreateSampler(_logicalDevice->GetDevice(), &samplerCreateInfo, nullptr, &_viewportImageSampler);
}
